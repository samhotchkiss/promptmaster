...
from promptmaster.projects import ensure_project_scaffold, project_worktrees_dir
from promptmaster.storage.state import StateStore, WorktreeRecord
...
def ensure_worktree(
    ...
    *,
    ...
    branch = f"promptmaster/{project_key}/{lane_kind}/{lane_key}"
    if not path.exists():
