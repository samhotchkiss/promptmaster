...
def polly_prompt() -> str:
    return (
        ...
        "TASK COMPLETION: When a task is complete, create an inbox item for the user summarizing what "
        "was built, how to test/verify it, and any decisions you made. Use: "
        "`pm notify \"Task complete: <title>\" \"Summary of what was built, commits made, how to test, "
        "and any follow-up needed.\"` The user may not be watching — the inbox is how they learn what happened. "
